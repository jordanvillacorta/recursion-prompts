...
var sumBelow = function(n) {
  ...
  if (n > 0) {
    var accumulator = n - 1;
    return accumulator + sumBelow(n - 1);
  }

  if (n < 0) {
    var negativeAccumulator = Math.abs(n) - 1;
...
var powerOfTwo = function(n) {
  // n = n/2 iteratively until n becomes 1
  // if n%2 becomes non-zero and n is not 1
...
var replaceKeysInObj = function(obj, oldKey, newKey) {
  for (var objectKey in obj) {
    ...
    if (typeof obj[objectKey] === 'object') {
      replaceKeysInObj(obj[objectKey], oldKey, newKey);
    }
  }
  return obj;
};
